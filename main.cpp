...
// 1. Solicita al usuario el número de ofertas y demandas.
// 2. Solicita la cantidad para cada oferta.
// 3. Solicita la cantidad para cada demanda.
// 4. Solicita la matriz de costos, que indica el costo de enviar una unidad de bienes desde cada oferta a cada demanda.
// 5. Imprime la solución obtenida y el costo total asociado.
